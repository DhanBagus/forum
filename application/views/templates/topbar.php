            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <ul class="navbar-nav ml-auto">
						...
						<div class="nav-nav-item mr-5 mt-4">
							<a href="<?php echo base_url('forum/inbox'); ?>"><i class="fas fa-envelope fa-lg"></i></i></a>
						</div>

						<div class="nav-nav-item mr-4 mt-4">
							<a href="<?php echo base_url('forum/mypost'); ?>"><i class="fas fa-paper-plane fa-lg"></i></a>
						</div>
